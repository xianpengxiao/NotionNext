...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'myfuwari', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SheepX', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个大三在读计算机系学生，正在酷酷找工作', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'SheepX', // 浏览器标签标题
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '一个大三在读计算机系学生，正在酷酷找工作',
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/images/sheepaimallicon.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
